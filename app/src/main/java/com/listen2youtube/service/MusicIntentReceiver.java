 ...
 * declaring it in a &lt;receiver&gt; playListTag in AndroidManifest.xml.
 */
        ...
        if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
                    service.setAction(MusicService.ACTION_TOGGLE_PLAYBACK);
                    break;
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    service.setAction(MusicService.ACTION_PLAY);
                    break;
                case KeyEvent.KEYCODE_MEDIA_PAUSE:
                    service.setAction(MusicService.ACTION_PAUSE);
                    break;
                case KeyEvent.KEYCODE_MEDIA_STOP:
                    service.setAction(MusicService.ACTION_STOP);
                    break;
            }
